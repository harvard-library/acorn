...
function loadTableFormat(recordtype)
{
	...
	function onFileListReady() {
		...
		var myDataSource = new YAHOO.util.DataSource(baseUrl + "groupfiles/findfiles?");
        ...
        filesDataTable = new YAHOO.widget.ScrollingDataTable("files", myColumnDefs, myDataSource, 
        		{initialRequest: initialReq, dynamicData: true, 
	 			scrollable:true, height:"35em", width:"100%"});
        ...
        if (window.isEditable && isEditable() && accesslevel == "Admin")
        {
	        ...
	        var onCellEdit = function(oArgs) {
				...
				var myAjax = new Ajax.Request(baseUrl + "groupfiles/renamefile",
				    	{method: 'get', 
...
{
	var myAjax = new Ajax.Request(baseUrl + "groupfiles/removefromtemporaryfiles",
	    	{method: 'get', 
